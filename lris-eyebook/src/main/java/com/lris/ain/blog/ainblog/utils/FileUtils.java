package com.lris.ain.blog.ainblog.utils;
...
public class FileUtils {
	...
	//string str = this.TextBox1.Text.Replace(" ","&nbsp").Replace("\r\n","<br>");
		...
		try {
			...
			*/
			...
			while((str=br.readLine())!=null) {
				str = str.replace("　","&nbsp").replace(" ","&nbsp");
	...
	public static File[] readFileFilter(File file,final String suffix) {
